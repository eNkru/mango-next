...
const messages = {
  'zh-cn': {
    ...
    previousEntry: '上一项', pagePrevious: '上一页', pageNext: '下一页',
    jumpGo: '跳转', readerError: '无法打开阅读器',
    ...
    githubRepository: 'GitHub 仓库', reportIssue: '报告问题或提供反馈',
    languageSimplifiedChinese: '简体中文', languageTraditionalChinese: '繁體中文', languageEnglish: '英语',
  ...
  'zh-tw': {
    ...
    previousEntry: '上一項', pagePrevious: '上一頁', pageNext: '下一頁',
    jumpGo: '跳轉', readerError: '無法開啟閱讀器',
    ...
    uiStyleComic: 'Comic', uiStyleFlat: 'Flat',
    githubRepository: 'GitHub 儲存庫', reportIssue: '回報問題或提供意見',
    languageSimplifiedChinese: '簡體中文', languageTraditionalChinese: '繁體中文', languageEnglish: '英文',
  ...
  en: {
    ...
    previousEntry: 'Previous entry', pagePrevious: 'Previous page', pageNext: 'Next page',
    jumpGo: 'Go', readerError: 'Unable to open reader',
    ...
    uiStyleComic: 'Comic', uiStyleFlat: 'Flat',
    githubRepository: 'GitHub repository', reportIssue: 'Report an issue or share feedback',
    languageSimplifiedChinese: 'Simplified Chinese', languageTraditionalChinese: 'Traditional Chinese', languageEnglish: 'English',
